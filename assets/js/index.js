...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('Evaluation', __webpack_require__(11));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__evaluation_data_flat__ = __webpack_require__(10);
...
var store = new __WEBPACK_IMPORTED_MODULE_1_vuex__["a" /* default */].Store({
  ...
  mutations: {
    ...
    removeCurrentFromTests: function removeCurrentFromTests(state) {
      var isAlreadyExists = state.tests.find(function (test) {
        return test.id == state.currentTestId;
      });
      if (isAlreadyExists) {
        return state.tests = state.tests.filter(function (test) {
          return test.id != state.currentTestId;
        });
      } else {
        return state;
...
var render = function() {
  ...
  return _c("div", { staticClass: "text-center evaluation-question-content" }, [
    ...
    _vm._v(" "),
    _vm.isSummary
      ? _c("div", { staticClass: "summary-block text-left" }, [
          _c("h2", { staticClass: "hfd_color text-center mb-4" }, [
            _vm._v("Your Dental profile")
          ]),
          _vm._v(" "),
          _c(
            "div",
              ...
              return _c("div", { staticClass: "col-md-6" }, [
                _c("p", [
                  _c("span", [
                    ...
                    _vm._v(" " + _vm._s(test.question) + " "),
                    _c("br")
                  ]),
                  _vm._v(" "),
                  _c("span", { staticClass: "hfd_color" }, [
                    _c("strong", [_vm._v("diagnosis: ")]),
                    _vm._v(_vm._s(test.diagnosis) + ". "),
                    _c("br"),
                    _vm._v(" "),
                    _c("strong", [_vm._v("treatment: ")]),
                    _vm._v(" " + _vm._s(test.treatment) + "\n          ")
                  ])
                ])
              ])
            })
          ...
          _c("div", { staticClass: "text-center" }, [
            _c("h2", { staticClass: "hfd_color" }, [
              _vm._v("Interested with our Treatments?")
            ]),
            _vm._v(" "),
            _c("p", [
              _c(
                "a",
                {
                  staticClass: "btn btn-hfd",
                  attrs: { href: _vm.appointmentUrl }
                },
                [_vm._v("Make an appointment now")]
              )
            ])
          ])
        ])
